                ...
                <ul>
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li><a href="index.php?p=admin_category_level_1">Catégories</a></li>
                            <li><a href="index.php?p=admin_category_level_2">Sous-catégories</a></li>
                            <li><a href="index.php?p=admin_ad">Liste Produits</a></li>
...
function subMyString($contenu,$limite) {
